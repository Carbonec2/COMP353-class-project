...
CREATE TABLE contract (
  id INTEGER PRIMARY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE deliverable_standard (
  ...
  PRIMARY_KEY (contract_type, deliverable),
...
CREATE TABLE contract_assignment (
  ...
  FOREIGN KEY asg_contract FOREIGN KEY (contract) REFERENCES contract (id),
  FOREIGN KEY asg_employee FOREIGN KEY (employee) REFERENCES employee (id)
);
...
CREATE TABLE deliverable_log (
  ...
  -- We should be able to do a constraint on contract_type + deliverable name, but this might violate NFs
  CONSTRAINT log_deliverable_standard FOREIGN KEY (deliverable) REFERENCES deliverable_standard (deliverable)
);
...
CREATE TABLE client (
  ...
  CONSTRAINT client_rep_account FOREIGN KEY client_rep REFERENCES account (id),
  CONSTRAINT client_valid_city FOREIGN KEY (city,province) REFERENCES city (city,province)
);
